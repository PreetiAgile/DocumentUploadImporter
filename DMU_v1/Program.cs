...
{   "Prerequisites",
    ...
    "Worker","Worker Dependents",
    "Worker Beneficiary",
    "Worker Emergency Contacts","Org Manager Update","Legacy Manager Worker Update","Reset Worker Compensation Amount","Worker Compensation Grade",
    "Worker Org Mapping",
...
"Delete Table Data",
"Delete Worker Lists",
"Worker Bank Account Payment Election"
        ...
        start:
            ...
            Console.WriteLine($"Version:46.1, Released On:29/05/2026");
            ...
            Console.WriteLine(string.Join(", ", availableUseCases.Skip(18).Take(8)));
            Console.WriteLine(string.Join(", ", availableUseCases.Skip(26).Take(1)));
            Console.WriteLine(string.Join(", ", availableUseCases.Skip(27).Take(6)));
            Console.WriteLine(string.Join(", ", availableUseCases.Skip(97).Take(1)));



            Console.WriteLine();
            Console.WriteLine("==========EVENTS==========");
            Console.WriteLine(string.Join(", ", availableUseCases.Skip(33).Take(15)));
            Console.WriteLine();
            Console.WriteLine("==========VALID VALUES ENTITIES==========");
            Console.WriteLine(string.Join(", ", availableUseCases.Skip(48).Take(6)));
            Console.WriteLine();
            Console.WriteLine("==========EXPORT ENTITIES==========");
            Console.WriteLine(string.Join(", ", availableUseCases.Skip(54).Take(17)));
            Console.WriteLine();
            Console.WriteLine("==========WORKER OTHER ENTITIES==========");
            Console.WriteLine(string.Join(", ", availableUseCases.Skip(71).Take(7)));
            Console.WriteLine();
            Console.WriteLine("==========DELETE ENTITIES==========");
            Console.WriteLine(string.Join(", ", availableUseCases.Skip(78).Take(19)));
        ...
        "Job Family Group","Job Family","Job Profile","Payment Election Rules","Position"
            ...
            foreach (var useCase in prerequisiteEntities)
            {
                try
                {
                    ...
                    bool isValidFormat = logger.ValidateFileFormat(workbook, jsonObj,useCase);
